...
//        LoginFunction loginFunction = new LoginFunction();
        List<String> urls = constructTestingTarget.readLinksFromFile("src/Data/batch3_UI");
...
//
    ...
    private static void takeScreenshot(WebDriver driver, String categoryName) {
        ...
        try {
            ...
            //File destFile = new File("C:\\Users\\NHANND12\\Pictures\\TopMenu_Navigation_Lists\\" + categoryName + ".png"); // output directory for PC
            File destFile = new File("C:\\Users\\NHANND12\\Pictures\\TopMenu_Navigation_Lists_Mobile\\" + categoryName + ".png"); // output directory for mobile
