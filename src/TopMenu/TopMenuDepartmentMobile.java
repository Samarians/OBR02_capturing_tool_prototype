...
import org.openqa.selenium.devtools.v127.network.model.SubresourceWebBundleMetadataError;
...
public class TopMenuDepartmentMobile {
...
//                "https://obayashig.sharepoint.com/sites/TeamSite_1020_0010/od_sbtnintei"
        ...
        try {
            ...
            for (String url : urls) {
                ...
                WebElement openMenu = driver.findElement(By.xpath(""));
